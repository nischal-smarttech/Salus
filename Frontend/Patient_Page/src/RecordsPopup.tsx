...
function RecordsPopup({ patient, onClose }: { patient: { name: string; healthSummary: string; trends: { bpAvg: number; bpTrend: string; hrAvg: number; hrTrend: string }; files: string[] }; onClose: () => void }) {

...
function PatientList({ onClose }: { onClose: () => void }) {
  const [searchTerm, setSearchTerm] = useState('');
  const [showRequestForm, setShowRequestForm] = useState<number | null>(null);
  const [showRecordsPopup, setShowRecordsPopup] = useState<number | null>(null);
